...
begin
    ...
    -- Instanciation de l'unitÈ de traitement
    ...
    begin
        ...
        -- 1. R(1) = R(15)  [Normalement R(15) initialisÈ ‡ 0x30 dans le code]
        -- On passe R(15) ‡† travers l'ALU (OP="01" pour laisser passer B)
        RB <= "1111";      -- Lire R(15) sur BusB
        ALUCtr <= "01";    -- ALU sort B
        RW <= "0001";      -- Destination R(1)
        RegWr <= '1';      -- Autoriser l'Ècriture
        wait for period;
