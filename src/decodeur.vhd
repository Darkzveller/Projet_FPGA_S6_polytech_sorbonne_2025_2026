...
begin
  ...
  begin
    ...
    -- Cas des accÃ¨s mémoires LDR / STR
  ...
  ---------------------------------------------------------------------------
  -- Processus 2 : Génération des signaux de contrÃ´le (SÃ‰CURISÃ‰)
  ---------------------------------------------------------------------------
  process (instr_courante, flag_N)
  begin
    -- CORRECTION : Initialisation systématique de TOUTES les sorties Ã  '0'
    ...
    case instr_courante is
      ...
      when STR =>
        MemWr   <= '1'; -- Ecriture active dans la mémoire
