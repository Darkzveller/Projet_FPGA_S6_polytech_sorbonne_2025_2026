...
begin
    ...
    begin
        ...
        MemToReg <= '0';
        ----------------------------------------------------------------
        -- TEST RegAff : affichage du registre R1
        ----------------------------------------------------------------
        report "TEST RegAff R1";
            
        -- RA <= "0001";
        -- RB <= "0001";        -- important : BusB = R1
        RegAff_en <= '1';
            
        wait until rising_edge(CLK);
            
        assert RegAff_out = x"0000000A"
        report "Erreur : RegAff_out ne vaut pas R1"
        severity error;
        ----------------------------------------------------------------
